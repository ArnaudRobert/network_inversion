...
tf.add_to_collection('h_conv1',h_conv1)

h_pool1 = max_pool_2x2(h_conv1)
tf.add_to_collection('h_pool1',h_pool1)
...
tf.add_to_collection('h_conv2',h_conv2)

h_pool2 = max_pool_2x2(h_conv2)
tf.add_to_collection('h_pool2',h_pool2)
...
tf.add_to_collection('h_fc1',h_fc1)

keep_prob = tf.placeholder(tf.float32)

h_fc1_drop = tf.nn.dropout(h_fc1, keep_prob)
tf.add_to_collection('h_fc1_drop',h_fc1_drop)
